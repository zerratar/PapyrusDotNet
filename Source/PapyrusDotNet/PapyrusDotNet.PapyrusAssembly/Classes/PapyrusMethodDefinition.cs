    ...
    public class PapyrusMethodDefinition : PapyrusMethodReference
    {
        ...
        public void UpdateInstructionOperands()
        {
            if (DeclaringState != null)
                Body.Instructions.ForEach(i => DeclaringState.DeclaringType.UpdateOperand(i, Body.Instructions));
            else if (DeclaringAssembly != null)
                Body.Instructions.ForEach(i => DeclaringAssembly.Types.First().UpdateOperand(i, Body.Instructions));
        }
