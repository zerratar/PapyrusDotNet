...
namespace PapyrusDotNet.Converters.Clr2Papyrus.Interfaces
{
    public interface IClrInstructionProcessor
    {
        ...
        /// <returns></returns>
        IEnumerable<PapyrusInstruction> ProcessInstructions(
        ...
        /// <returns></returns>
        string GetTargetVariable(Instruction instruction, MethodReference methodRef, out bool isStructAccess,
        ...
        /// <returns></returns>
        IEnumerable<PapyrusInstruction> ProcessConditionalInstruction(Instruction instruction,
